...
2. Create a container with the same name via [LuCI](192.168.1.1/cgi-bin/luci/) _> Services > LXC Containers_
3. Browse to: `root@turris:~# lxc-start -n <container-name>`.
